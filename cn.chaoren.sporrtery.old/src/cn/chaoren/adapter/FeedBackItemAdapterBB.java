...
public class FeedBackItemAdapterBB extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    if (convertView == null) {
			convertView =mInflater.inflate(R.layout.feedback_bb, null);
		}
	    ...
	    tempText = (TextView) convertView.findViewById(R.id.homeLose);
	    
	    tempText.setText(mContext.getString(R.string.homelose)+"" + data.get("" + tempText.getTag()));
	    tempText = (TextView) convertView.findViewById(R.id.homeWin);
	    tempText.setText(mContext.getString(R.string.homewin)+"" + data.get("" + tempText.getTag()));
